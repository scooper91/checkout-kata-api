...
{
	class BasketStoreTests
	{
		[Test]
		public void Should_return_valid_basket()
		{
		...
		[Test]
		public void Should_return_unique_basket_ids_between_basket_stores()
		{
		...
		[Test]
		public void Should_return_basket_given_basket_id()
		{
			var basketStore = new BasketStore();
			var basket = new Basket();
			var basketId = basketStore.Add(basket);
		...
		[Test]
		public void Should_retrieve_existing_basket_from_new_basket_store()
		{
			var basketStore = new BasketStore();
			var basket = new Basket();
			var basketId = basketStore.Add(basket);
